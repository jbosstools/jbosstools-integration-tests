...
public class DataOrderedListTagTest extends AbstractTagTest {
	...
	protected void verifyTag() {
		assertVisualEditorContains(getVisualEditor(), "OL", new String[] { "class" },
				new String[] { "dr-list rich-orderedlist" }, getTestPageFileName());
		assertVisualEditorContains(getVisualEditor(), "LI", new String[] { "class" },
				new String[] { "dr-list-item rich-list-item" }, getTestPageFileName());
		assertVisualEditorContainsNodeWithValue(getVisualEditor(), DataOrderedListTagTest.ROW_0_VALUE,
				getTestPageFileName());
		assertVisualEditorContainsNodeWithValue(getVisualEditor(), DataOrderedListTagTest.ROW_1_VALUE,
				getTestPageFileName());
		assertVisualEditorContainsNodeWithValue(getVisualEditor(), DataOrderedListTagTest.ROW_2_VALUE,
				getTestPageFileName());
		// check tag selecti

...
public class HtmlCommandLinkTagTest extends AbstractTagTest {
	...
	protected void verifyTag() {
		assertVisualEditorContains(getVisualEditor(), "INPUT", new String[] { "type" }, new String[] { "Submit" },
				getTestPageFileName());
		assertVisualEditorContains(getVisualEditor(), "A", null, null, getTestPageFileName());
		assertVisualEditorContainsNodeWithValue(getVisualEditor(), HtmlCommandLinkTagTest.LINK_VALUE,
				getTestPageFileName());
		// check tag selection

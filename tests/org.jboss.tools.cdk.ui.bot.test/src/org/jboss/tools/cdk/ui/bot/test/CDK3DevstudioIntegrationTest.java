...
public class CDK3DevstudioIntegrationTest extends CDKDevstudioAbstractTest {
	...
	private static final String HYPERVISOR;
	...
	static {
		...
		HYPERVISOR = getSystemProperty("hypervisor"); //$NON-NLS-1$
	}
	...
	private static void checkMinishiftParams() {
		...
		log.info(HYPERVISOR + " is set as hypervisor"); //$NON-NLS-1$		
	}
	...
	private static void addNewCDEServer() {
		...
		if (HYPERVISOR != null && !HYPERVISOR.isEmpty()) {
			...
			containerPage.setHypevisor(HYPERVISOR);
		}

...
public class OpenShiftLabel {
	...
	public static class AppType {
		...
		public static final String JBOSS_EAP_ENTERPRISE = "JBoss Enterprise Application Platform 6.0" + " " + "jbosseap-6.0";
		...
		public static final String JBOSS_EAP_ENTERPRISE_TREE = "JBoss Enterprise Application Platform 6.0" + " (" + "jbosseap-6.0" + ")";
		public static final String JBOSS_EAP_ONLINE_TREE = "JBoss Enterprise Application Platform 6" + " (" + "jbosseap-6" + ")";
		public static final String JBOSS_EWS_TREE = "Tomcat 7 (JBoss EWS 2.0)" + " (" + "jbossews-2.0" + ")";
		public static final String JENKINS_TREE = "Jenkins Server 1.4" + " (" + "jenkins-1.4" + ")";

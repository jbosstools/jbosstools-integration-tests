...
public class CreateDeleteJBossApp extends SWTTestExt {
	...
	public void canCreateJBossApp() {
		...
		// fill app info
		bot.textInGroup("New application", 0).typeText(JBOSS_APP_NAME);
		...
		servers.show();
		assertTrue(servers.serverExists(JBOSS_APP_NAME + " at OpenShift"));
	...
	public void canDeleteJBossApp() {
		...
		account.getNode(JBOSS_APP_NAME + " " + OpenShiftUI.AppType.JBOSS_EAP)
		...
		servers.show();
		servers.deleteServer(JBOSS_APP_NAME + " at OpenShift");
	}

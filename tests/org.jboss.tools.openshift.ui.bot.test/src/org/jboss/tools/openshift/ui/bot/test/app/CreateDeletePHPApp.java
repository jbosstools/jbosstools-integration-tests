...
public class CreateDeletePHPApp extends SWTTestExt {
	...
	public void canCreatePHPApp() {
		...
		servers.show();
		assertTrue(servers.serverExists(PHP_APP_NAME + " at OpenShift"));
	...
	public void canDeletePHPApp() {
		...
		account.getNode(PHP_APP_NAME + " " + OpenShiftUI.AppType.PHP)
		...
		servers.show();
		servers.deleteServer(PHP_APP_NAME + " at OpenShift");
	}
}

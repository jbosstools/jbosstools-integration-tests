...
public class CreateDeletePythonApp extends SWTTestExt {
	...
	public void canCreatePythonApp() {
		...
		servers.show();
		assertTrue(servers.serverExists(PYTHON_APP_NAME + " at OpenShift"));
	...
	public void canDeletePythonApp() {
		...
		account.getNode(PYTHON_APP_NAME + " " + OpenShiftUI.AppType.PYTHON)
		...
		servers.show();
		servers.deleteServer(PYTHON_APP_NAME + " at OpenShift");
	}
}

...
import org.jboss.tools.modeshape.rest.ui.bot.ext.util.TeiidDriver;
 ...
 * 
 */
@Require(server = @Server(type = ServerType.SOA, state = ServerState.Running), perspective = "Teiid Designer")
public class TeiidFilesPublishing extends SWTTestExt {
	...
	public void testTeiidPublishing() throws Exception {
		...
		Connection conn = DriverManager.getConnection("jdbc:teiid:ModeShape@mm://localhost:31000",
				"user", "user");

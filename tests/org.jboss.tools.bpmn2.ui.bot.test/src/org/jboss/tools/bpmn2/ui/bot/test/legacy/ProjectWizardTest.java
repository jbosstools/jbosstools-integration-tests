...
public class ProjectWizardTest extends SWTTestExt {
	...
	NewJBpmProjectWizard wizardView  = new NewJBpmProjectWizard();
	...
	public void newProjectWithSimpleProcessTest() throws Exception {
		wizardView.execute("TestProject", NewJBpmProjectWizard.ProcessType.SIMPLE, true, false);
	...
	public void newProjectWithAdvancedProcessTest() {
		wizardView.execute("TestProject", NewJBpmProjectWizard.ProcessType.ADVANCED, true, true);

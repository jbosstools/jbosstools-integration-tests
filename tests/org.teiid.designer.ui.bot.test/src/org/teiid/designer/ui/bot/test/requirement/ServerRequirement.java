...
public class ServerRequirement implements Requirement<Server> {
	...
	public boolean canFulfill() {
		return TeiidSuite.getServerName() != null;
	}

	@Override
	public void fulfill() {
		new WaitUntil(new ServerHasState(TeiidSuite.getServerName()), TimePeriod.LONG);

		org.jboss.reddeer.eclipse.wst.server.ui.view.Server server = null;
		server = new ServersView().getServer(TeiidSuite.getServerName());

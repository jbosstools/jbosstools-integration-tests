...
_=JBoss Tools Integration Tests_ is part of [JBoss Tools](http://jboss.org/tools) from
...
To build _=JBoss Tools Integration Tests_ requires specific versions of Java and
...
_=JBoss Tools Integration Tests_ is open source, and we welcome anybody that wants to

...
public class RunConfigurationsDialog {
	...
	public void createConfiguration(RunConfiguration configuration){
		...
		new WaitUntil(new WidgetIsFound<org.eclipse.swt.widgets.Text>(new ClassMatcher(org.eclipse.swt.widgets.Text.class), new WithLabelMatcher("Name:")), TimePeriod.LONG);

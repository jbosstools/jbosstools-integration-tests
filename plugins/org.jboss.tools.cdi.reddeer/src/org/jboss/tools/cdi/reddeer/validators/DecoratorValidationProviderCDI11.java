...
public class DecoratorValidationProviderCDI11 extends AbstractValidationProvider {
	
	private final String jsr = "JSR-346"; 

	public DecoratorValidationProviderCDI11() {
		super();
	}
	...
	void init() {
		problems.add(new ValidationProblem(ProblemType.WARNING, ValidationType.NAMED, 
				"Decorator should not have a name",jsr,
				Arrays.asList("Delete annotation @Named from class")));

...
public class RunADockerImagePageOneWizard extends WizardPage{
	...
	public void addLinkToOtherContainer(String containerPort, String hostAddress, String hostPort){
	...
	public void addContainerPort(String containerName, String alias){
		new PushButton("Add..").click();
